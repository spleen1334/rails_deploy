class passenger {
  exec {
    "/usr/local/bin/gem install passenger -v=3.0.11":
      ...
      unless => "/bin/ls /usr/local/lib/ruby/gems/1.9.1/gems/passenger-3.0.11/"
    }
	...
	unless => "/bin/ls /usr/local/lib/ruby/gems/1.9.1/gems/passenger-3.0.11/ext/apache2/mod_passenger.so"
      }
